...
<!-- start page -->
		<?php //get_page($db, $page); ?>
			<article>
				<h3>Introducere</h3>
				<?php echo '<p class="al-txt-red">',site_settings($db, 'site_name'),'</p>'; ?>
				<?php echo '<p class="al-txt-red">',page_settings($db, $page, 'page_title'),' - for head</p>'; ?>
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus, cupiditate aperiam repudiandae provident magnam minima dolore, ad dolorum perspictiatis officia tempore illo sit reprehenderit ratione. Aut vitae temporibus itaque dolores.</p>
